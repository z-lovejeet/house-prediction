 ...
 * All icons are 24×24 stroke-based for consistency.
 */
...
export function IconBed({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 7v4a1 1 0 001 1h3m10 0h3a1 1 0 001-1V7M3 7h18M3 7V5a2 2 0 012-2h14a2 2 0 012 2v2M7 12v5m10-5v5M5 17h14a2 2 0 002-2v-1H3v1a2 2 0 002 2z" />
    </svg>
  );
}

export function IconBath({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 14h16M4 14v4a2 2 0 002 2h12a2 2 0 002-2v-4M4 14V8a4 4 0 014-4h1m3 10V6.5a1.5 1.5 0 013 0V7" />
    </svg>
  );
}
...
export function IconChevron({ className = "w-4 h-4", direction = "down" }) {
  const rotate = { up: "rotate-180", down: "", left: "rotate-90", right: "-rotate-90" };
  return (
    <svg className={`${className} ${rotate[direction]} transition-transform`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
